<template>
  <div class="page">
    <transition name="fade">
      <div v-if="page && Object.keys(article).length" class="container">
        <div class="page-image">
          ...
          <div class="page-image-header">
            ...
            <div class="page-image-date" v-html="article.date" />
          </div>
          <h1 class="page-title" v-html="article.title.en" />
        </div>
        <div class="page-content" v-html="article.content.en">
