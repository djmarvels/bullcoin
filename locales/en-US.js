export default {
    ...
    Index : {
        Header : {
            Title  : '<b>Get bull</b><br>by the horns',
            Button : 'Buy bull now',
            Text   : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. At cursus malesuada enim nulla odio vitae velit convallis aenean.'
        },
        Live : {
        ...
        Ecosystem : {
            Title  : '<b>ECO</b>SYSTEM',
            Text   : 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. At cursus malesuada enim nulla odio vitae velit convallis aenean.',
            Tabs   : ['Liquidity Locked<br>to Uniswap', 'First burn<br>to VB', 'Second burn<br>to VB'],
            More   : 'More info',
            Bottom : [
                '<i>LEASH</i>  was originally set to be a rebase token pegged to the price of Dogecoin. Now, it has been unleashed and will not rebase. \n' +
              ...
              'The second token incentivized on the swap offers special rewards for those who provide liquidity.  ',
                '<i>BONE</i> Dogecoin Killer is our next token! <i>COMING SOON</i>, Shiba Inu Bone, takes the power of Defi to the next level. \n' +
    ...
    Terms : {
        ...
        'Country\n' +
        'refers to: Utah, United States.\n' +
        'Company\n' +
        '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to SafeMoon LLC, 364 N 500 E Provo, UT 84606.\n' +
        'Device\n' +
        'means any device that can access the Service such as a computer, a cellphone or a digital tablet.\n' +
        '<span class="white">Service</span>\n' +
        'refers to the Website.\n' +
        'Terms and Conditions\n' +
        '(also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and Safemoon LLC regarding the use of the Service.\n' +
        ...
        'Website\n' +
        'refers to SafeMoon, accessible from https://safemoon.net\n' +
        'You\n' +
        ...
        '\n' +
        '<span class="white">Links to Other Websites</span>\n' +
        ...
        '\n' +
        '<span class="white">Termination</span>\n' +
    ...
    Wallet : {
        ...
        SubTitle : 'Enter your safemoon wallet address below to get started.',
        Form     : {
            Input  : 'You text input',
